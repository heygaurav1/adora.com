    ...
    <div className="min-h-screen bg-black text-white font-sans selection:bg-white selection:text-black flex flex-col items-center">
      ...
      <main id="main-content" className="w-full max-w-[1400px] px-4 md:px-8 py-20 flex flex-col items-center">
        <div className="flex flex-col items-center text-center mb-24">
           <span className="text-[12px] font-light tracking-[0.6em] text-red-600 mb-6 uppercase">Exclusive Discounts</span>
           <h1 className="text-[48px] md:text-[80px] font-light uppercase tracking-tighter leading-none mb-10">SEASONAL<br/>SALE</h1>
