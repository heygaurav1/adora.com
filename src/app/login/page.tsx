...
import { Mail, Lock, Chrome, Apple, ArrowRight, Loader2, AlertCircle } from "lucide-react";
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-white selection:text-black flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-zinc-900/40 blur-[150px] rounded-full pointer-events-none" />
      ...
      <main className="w-full max-w-[500px] px-8 relative z-20 mt-20 md:mt-0">
        ...
        >
          <div className="flex flex-col items-center mb-10">
            <h1 className="text-[28px] font-extralight tracking-tight mb-3 text-white">Welcome back</h1>
            <p className="text-[13px] text-zinc-500 text-center font-light leading-relaxed max-w-[280px]">
              Securely access your ADORA profile with your credentials.
            </p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                <label className="text-[10px] uppercase tracking-[0.2em] text-zinc-600 font-light">Cipher Access</label>
                <Link href="/forgot" className="text-[10px] text-zinc-500 hover:text-white font-normal tracking-[0.1em] uppercase transition-colors">Forgot Access?</Link>
              </div>
              <div className="relative group">
                <input 
                  type="password" 
          ...
          <div className="mt-12 text-center">
            <p className="text-[11px] text-zinc-600 font-light uppercase tracking-[0.2em]">
              Not a member of the house? <br />
              <Link href="/register" className="text-white hover:text-blue-400 transition-all font-normal mt-2 inline-block border-b border-white/10 hover:border-blue-400">Join the Collective</Link>
            </p>
          </div>
        </motion.div>
      </main>
