...
export default function RustCheckoutDemo() {
  return (
    <div className="min-h-screen bg-[#fafafa] flex flex-col items-center justify-center py-20 px-6 font-sans">
      <div className="w-full max-w-[500px] bg-black rounded-3xl p-10 md:p-14 shadow-2xl border border-white/5 flex flex-col items-center text-center">
        
        {/* Adora Branded Header */}
        <Link href="/" className="mb-10 text-zinc-500 hover:text-white transition-colors flex items-center gap-2 text-[10px] font-light uppercase tracking-widest">
            <ArrowLeft className="w-4 h-4" /> Go back
        </Link>

        {/* Product Card Placeholder */}
        <div className="w-32 h-32 bg-zinc-950/50 rounded-2xl flex items-center justify-center mb-8 relative">
        ...
        <h1 className="text-[24px] font-light lowercase tracking-tight text-zinc-500 mb-2 first-letter:uppercase italic">
          Sage Olive Bomber Jacket
        </h1>
        <p className="text-[12px] text-zinc-500 mb-10 uppercase tracking-[0.2em] font-normal">
        ...
        <div className="flex flex-col gap-3 w-full border-t border-white/5 pt-8 mt-4">
            <div className="flex items-center gap-4 text-left">
                <div className="p-3 bg-red-50 text-red-600 rounded-xl">
                    <ShieldCheck className="w-6 h-6" />
                </div>
                <div>
                   <h3 className="text-[11px] font-light uppercase tracking-wider text-zinc-500">
      ...
      <p className="mt-12 text-[10px] text-zinc-500 font-light uppercase tracking-[0.3em]">
