    ...
    <div className="min-h-screen bg-black text-white font-sans selection:bg-white selection:text-black flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <main className="w-full max-w-[420px] px-8 relative z-20">
        <div className="flex flex-col items-center mb-12">
          ...
          <p className="text-[14px] text-zinc-500 text-center font-light leading-relaxed italic">
        ...
        <form onSubmit={handleRegister} className="space-y-6">
          <div className="space-y-2">
            <label className="text-[11px] uppercase tracking-[0.1em] text-zinc-500 font-light pl-1">Full Name</label>
            <div className="relative group">
              <input 
                ...
                className="w-full h-14 bg-[#111] border border-white/5 rounded-xl px-12 text-[14px] font-light placeholder:text-zinc-500 focus:border-white/50 focus:bg-black/50 transition-all outline-none"
                required
              />
          ...
          <div className="space-y-2">
            <label className="text-[11px] uppercase tracking-[0.1em] text-zinc-500 font-light pl-1">Password</label>
            <div className="relative group">
              <input 
                type="password" 
                value={password}
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full h-14 bg-black text-white rounded-xl text-[14px] font-normal tracking-wide hover:bg-zinc-950/50 transition-all flex items-center justify-center gap-2 group disabled:opacity-50"
          >
        ...
        <div className="relative py-10 flex items-center justify-center">
          ...
          <span className="relative bg-black px-4 text-[11px] text-zinc-500 font-light uppercase tracking-[0.2em]">or sign up with</span>
        </div>
